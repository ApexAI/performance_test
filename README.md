...
```
update performance_test/CMakeLists.txt to have OpenDDS option set on
option(PERFORMANCE_TEST_OPENDDS_ENABLED "Enable OpenDDS" ON)

and set FAST_RTPS option off
```
